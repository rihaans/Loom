...
from agentforge.agents.prompts.backend_dev import (
    BACKEND_DEV_HUMAN_TEMPLATE,
    BACKEND_DEV_SYSTEM_PROMPT,
)
from agentforge.agents.prompts.devops_engineer import (
...
from agentforge.agents.prompts.product_manager import (
    PRODUCT_MANAGER_HUMAN_TEMPLATE,
    PRODUCT_MANAGER_SYSTEM_PROMPT,
)
from agentforge.agents.prompts.qa_engineer import (
