...
from agentforge.agents.prompts import (
...
from agentforge.state.models import PRD, CostEntry, Event
...
async def product_manager_node(
    ...
    Args:
        ...
        config: Optional AgentForge configuration (uses default if not provided)
