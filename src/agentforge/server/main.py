"""FastAPI application for AgentForge web dashboard."""
...
from agentforge.config import load_config, parse_llm_string
from agentforge.server.models import (
    ArtifactResponse,
    BuildRequest,
    BuildResponse,
    RunStatus,
...
from agentforge.server.runner import get_runner
...
async def lifespan(app: FastAPI):
    ...
    logger.info("Starting AgentForge server")
    yield
