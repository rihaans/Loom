...
from loom.sandbox.models import SandboxConfig, SandboxResult, TestRunConfig
...
def create_sandbox_runner(config: SandboxConfig | None = None) -> SandboxRunnerProtocol:
    ...
    2. Subprocess (fallback, requires LOOM_UNSAFE_SANDBOX=1)
    ...
    try:
        from loom.sandbox.subprocess_runner import (
            SubprocessRunner,
...
def get_sandbox_info() -> dict[str, bool]:
    ...
    # Check subprocess
    try:
        from loom.sandbox.subprocess_runner import is_unsafe_sandbox_enabled
